...
Build a static-cache baseline (cached dense dets -> ByteTracker -> preds)::
    ...
    python -m dynamic_tiling.run_mot_eval \
        --from-static-cache dynamic_tiling/runs/cache/dense_0026.db \
        --classes 1 --src-wh 3840x2160 --fps 30 \
        --pred-out dynamic_tiling/runs/mot/static_0026_fov50.json \
        --gt-tracks dynamic_tiling/runs/gt_verify_0026_fov50/gt_tracks.verified.json
...
def replay_static_cache(db_path, *, classes, src_wh=None, nms_thr=0.5,
    ...
    from .target_lock import MultiTargetLock
