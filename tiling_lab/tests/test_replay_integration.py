...
from tiling_lab.harness.replay import run, run_multi
...
def test_run_dynamic_default_dump_mot_person_matches_input(tmp_path, monkeypatch):
    ...
    import sys
    import numpy as np
    from tiling_lab.cli import run_dynamic
    from hailo_tiling.types import CropRect
...
def test_emit_frames_json_keeps_tiles_and_appends_lock_box(tmp_path):
    import json
    from tiling_lab.harness.replay import RunResult, emit_frames_json
...
def test_run_dynamic_backend_uses_class_offset_one(monkeypatch, tmp_path):
    ...
    import tiling_lab.cli.run_dynamic as rd
