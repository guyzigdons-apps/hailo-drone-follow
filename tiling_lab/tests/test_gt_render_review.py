from tiling_lab.gt.gt_review import ReviewCase
from tiling_lab.gt.gt_render_review import case_caption, norm_to_px
...
def test_crop_region_covers_boxes_with_margin_and_min_size():
    from tiling_lab.gt.gt_render_review import crop_region
