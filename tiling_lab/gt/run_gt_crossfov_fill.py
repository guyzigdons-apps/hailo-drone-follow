"""CLI: fill an unstable track from the same object's clean track in another FOV.
    ...
    python -m tiling_lab.gt.run_gt_crossfov_fill \
        --outdir tiling_lab/runs/gt_verify_0025_fov60 --track-id 4 \
        --src-dir tiling_lab/runs/gt_verify_0025_fov50 --src-track-id 4 \
...
from hailo_tiling.geometry import fov_to_crop_dims
