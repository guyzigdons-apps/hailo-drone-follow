...
Example:
    source setup_env.sh
    python -m tiling_lab.cli.run_dynamic \
        ...
        --out tiling_lab/runs/dynamic_run.frames.json
"""
...
from hailo_tiling.dynamic.scheduler import TileScheduler, MultiTargetTileScheduler
from tiling_lab.harness.target_lock import TargetLock, MultiTargetLock
from tiling_lab.harness.inference import HefBackend
from tiling_lab.gt.gt_track import build_target_trajectory
from tiling_lab.harness.score import score_run
from tiling_lab.harness.replay import run, run_multi, emit_frames_json
...
def main():
    ...
    ap.add_argument("--out", type=Path,
                    default=Path("tiling_lab/runs/dynamic_run.frames.json"))
