"""CLI: video + gt_tracks.json -> per-trial + aggregate tracking/recovery metrics.
    ...
    python -m tiling_lab.cli.run_trials \
        ...
        --gt-tracks tiling_lab/runs/gt_tracks_0026_fov50.json \
...
def build_reid_assist_factory(*, reid_policy, reid_hef, reid_cache,
    ...
    from tiling_lab.reid.reid_policy import POLICIES, ReidAssist
...
def main():
    ...
    on_result = None
    if args.dump_frames:
        from tiling_lab.harness.replay import emit_frames_json
