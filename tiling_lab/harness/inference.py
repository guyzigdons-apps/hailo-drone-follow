...
used by `tiling_lab.cli.run_dynamic` and `tiling_lab.harness.replay`. The wrapped
...
`tiling_lab.tests.test_inference`. The Plan-1-style per-crop API
...
class InferenceBackend(Protocol):
    """Legacy single-crop protocol; preserved for tiling_lab.harness callers.
