"""Standalone HailoRT probe for phantom (0,0,1,1) class-0 person detections.

Loads a HEF directly via `hailo_platform` (no GStreamer, no post-process .so),
feeds a set of controlled inputs, dumps the raw NMS-by-class output. Helps
isolate whether the phantom originates inside the HEF itself or somewhere in
the GStreamer / yolo_hailortpp_postprocess plumbing.

Usage:
    python tiling_benchmark/probe_phantom_hef.py \
